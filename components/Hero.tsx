            ...
            ">
                ...
                lg:max-w-[60vw] flex flex-col items-center justify-center'>
                    ...
                    text-xs text-center text-blue-100 max-w-80">
                        A stunning person and an even more stunning developer.
                    </h2>

                    <TextGenerateEffect
                        className="text-center text-[40px] md:text-5xl lg:text-6xl"
                        words="Hi, I&apos;m Sam, a Waterloo student & Software Developer"
                    />

                    <p className="text-center md:tracking-wider mb-4 text-sm
                    md:text-lg lg:text-2xl">
                        View my journey in technology, finance, and software development.
                    </p>
